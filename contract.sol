...
contract COINHALO is BEP20, BEP20Burnable, Pausable, Ownable {
    mapping(address => bool) public lockedOf;
    mapping(address => uint256) public lockedOfamount;

    uint256 public _totalSupply;

    constructor() BEP20("COIN HALO", "PGC") {
    ...
    function delegateBySig(
        ...
        require(
            signatory != address(0),
            "PGC::delegateBySig: invalid signature"
        );
        require(
            nonce == nonces[signatory]++,
            "PGC::delegateBySig: invalid nonce"
        );
        require(
            block.timestamp <= expiry,
            "PGC::delegateBySig: signature expired"
        );
        ...
        returns (uint256)
    {
        require(
            ...
            "PGC::getPriorVotes: not yet determined"
        );
    ...
    function _writeCheckpoint(
        ...
        uint32 blockNumber = safe32(
            block.number,
            "PGC::_writeCheckpoint: block number exceeds 32 bits"
        );
